export default {
    ...
    contribute: {
        ...
        options: {
            code: {
                description: 'Пропонуй ідеї, логуй баги або ж створюй пул ріквести в GitHub!'
            },
            chat: {
                title: 'Приєднайся до чату',
                description: 'Допоможи новачкам освоїти Vapor.'
            },
            donate: {
                title: 'Стати спонсором',
                description: 'Зроби одноразовий внесок або ж стань постійним спонсором, щоб підтримати проект'
            }
        }
    },
    sponsors: {
