export default {
    header: {
        slogan: 'The future of web development.'
    },
    callToAction: {
        start: 'Get Started',
        join: 'Join Chat'
    ...
    contribute: {
        ...
        options: {
            code: {
                description: 'Submit feature ideas, report bugs, and merge code on GitHub!'
            },
            chat: {
                title: 'Join Chat',
                description: 'Help newcomers learn the ropes and get started with Vapor.'
            },
            donate: {
                title: 'Become Backer',
                description: 'Make a one-time or recurring donation to support development.'
            }
        }
    },
    sponsors: {
