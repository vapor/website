export default {
    header: {
        slogan: 'Будущее веб-разработки.'
    },
    callToAction: {
        start: 'Начало работы',
        join: 'Присоединяйтесь к чату'
    },
    nav: {
        code: 'Код',
        cloud: 'Cloud',
    ...
    contribute: {
        ...
        options: {
            code: {
                description: 'Отправляйте идеи, сообщайте об ошибках и добавляйте код на GitHub!'
            },
            chat: {
                title: 'Присоединяйтесь к чату',
                description: 'Помогите новичкам освоить Vapor.'
            },
            donate: {
                title: 'Станьте спонсором',
                description: 'Сделайте единоразовое или периодические пожертвования, чтобы поддержать разработку.'
            }
        }
    },
    sponsors: {
