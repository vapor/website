export default {
    header: {
        slogan: 'Il futuro dello sviluppo web.'
    },
    callToAction: {
        start: 'Per cominciare',
        join: 'Unisciti alla chat'
    },
    nav: {
        code: 'Code',
        cloud: 'Cloud',
    ...
    contribute: {
        ...
        options: {
            code: {
                description: 'Invia idee, segnala bug, ed esegui merge su GitHub!'
            },
            chat: {
                title: 'Unisciti alla chat',
