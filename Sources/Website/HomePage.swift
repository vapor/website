...
struct HomePage: Component {
    ...
    var body: any Component {
        Node.body {
            ...
            Script(url: VaporDesignUtilities.buildResourceLink(for: "/static/js/scrollNavbar.js", isLocal: true))
            Script(url: VaporDesignUtilities.buildResourceLink(for: "/static/js/scrollShowcase.js", isLocal: true))
        }.id("main-page-body").class("main-site-faded-background")
    }
}
