...
let italianStrings: [String: String] = [
    ...
    "footer.tagline": "Vapor offre una base sicura, performante e facile da usare per creare server HTTP, backend e API in Swift",
    // Buttons / controls.
    ...
    "footer.frameworkDocs": "Documentazione del Framework",
