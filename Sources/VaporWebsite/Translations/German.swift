...
let germanStrings: [String: String] = [
    ...
    "footer.frameworkDocs": "Framework-Dokumentation",
    ...
    "footer.tagline": "Vapor bietet eine sichere, performante und einfach zu bedienende Grundlage, um HTTP-Server, Backends und APIs in Swift zu erstellen",
